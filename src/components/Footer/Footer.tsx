...
const footerData = {
  ar: {
    description: 'نقدم حلولاً تقنية مبتكرة تساعد الشركات على النمو والتطور في عالم الأعمال الرقمي.',
    ...
    email: 'info@injaz.com',
    copyright: '© 2026 إنجاز. جميع الحقوق محفوظة.',
  },
  en: {
    description: 'We provide innovative technology solutions that help companies grow and develop in the digital business world.',
      ...
      <div className="section-container" ref={ref}>
        <div className={styles.top}>
          ...
          <div className={styles.newsletterCol}>
            <h4 className={styles.colTitle}>{data.newsletter}</h4>
            <p className={styles.newsletterDesc}>{data.description}</p>
